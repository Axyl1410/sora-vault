...
module private_publishing::publication {
    ...
    /// Note: TransferPolicy for SubscriptionNFT should be created after deployment
    /// using marketplace_policies::create_transfer_policy_with_royalty
    /// This is done separately to avoid dependency cycle with subscription module
