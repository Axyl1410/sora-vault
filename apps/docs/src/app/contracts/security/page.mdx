...
- [Module API](/contracts/api) - Function reference
- [Testing Guide](/contracts/testing) - Security testing
- [Data Structures](/contracts/data-structures) - Object definitions
- [Events](/contracts/events) - Audit trail events
