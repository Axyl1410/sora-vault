...
- [Module API](/contracts/api) - Functions that emit events
- [Integration Guide](/contracts/integration) - Event handling examples
- [Data Structures](/contracts/data-structures) - Event field types
- [Security Guide](/contracts/security) - Event-based audit trails
