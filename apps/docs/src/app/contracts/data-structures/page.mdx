...
- [Module API](/contracts/api) - Function signatures and usage
- [Events Reference](/contracts/events) - All emitted events
- [Integration Guide](/contracts/integration) - TypeScript examples
- [Security Guide](/contracts/security) - Security considerations
