...
**Current Deployment:**
- **Network**: Sui Testnet
- **Package ID**: `0x7a9208857a5aaf48bd3d6832e0326017a34a13cb71f627c5ccf2998616aa1506` (Updated)
- **Previous Package ID**: `0x93d858ad26012ee80a48d1c07dc811966a6b06b2830c8972b4178df213b9b306` (Old)
...
- **Note**: Package ID đã được update trong `networkConfig.ts`. Nếu gặp vấn đề với Publisher, kiểm tra xem Publisher có thuộc package đúng không.
...
**Current Package**: `0x7a9208857a5aaf48bd3d6832e0326017a34a13cb71f627c5ccf2998616aa1506`
