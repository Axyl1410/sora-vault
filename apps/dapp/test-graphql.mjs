...
const packageId =
	"0xf72cca43c73677a73f53a7536e92c34b68d2eb8e4d5f4e6fbadf5501850995f3";
const publicationId =
	"0xfd5db4ac5ac878972f3c4eae48e657a4f0955b594352223b1ce06ea47db1daa1";
...
try {
	...
	if (resultOne.data?.object) {
		...
		console.log(
			JSON.stringify(
				resultOne.data.object.asMoveObject?.contents?.json,
				null,
				2,
			),
		);
