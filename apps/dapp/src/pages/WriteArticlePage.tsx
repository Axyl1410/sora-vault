...
export function WriteArticlePage() {
	...
	const {
		data: publisherPublications,
		isLoading,
		error,
	} = usePublisherPublications();
						...
						<Callout.Root>
							...
							<Callout.Text>
								...
								<Text size="1" color="gray" as="div">
									1. Your article content is encrypted with Seal protocol
									<br />
									2. Encrypted data is stored on Walrus decentralized storage
									<br />
									3. An on-chain article object is created with metadata
									<br />
