...
export function BackendInfoPage() {
	...
	const moveModules = [
		{
			name: "access_control",
			description: "Publisher and role-based access control",
		},
		{
			name: "analytics",
			description: "On-chain analytics tracking for articles",
		},
		{ name: "article", description: "Core article management with encryption" },
		{
			name: "marketplace_policies",
			description: "Transfer policies for marketplace trading",
		},
		...
		{
			name: "treasury",
			description: "Platform treasury and revenue distribution",
		},
	];
			...
			<Flex direction="column" gap="6">
				...
				<Flex direction="column" gap="3">
					...
					<Text size="3" color="gray">
						Comprehensive information about the deployed Move smart contracts
						and network configuration. This page is designed for developers and
						learners to understand the backend architecture.
					</Text>
				</Flex>
						...
						<Flex direction="column" gap="3">
							...
							<Box>
								...
								<Text color={isDeployed ? "green" : "orange"}>
									{isDeployed
										? "Package deployed and configured"
										: "Package not yet deployed (packageId: 0x0)"}
								</Text>
							</Box>
						</Flex>
					</Flex>
				...
				<Card>
					<Flex direction="column" gap="4">
						...
						<Text size="2" color="gray">
							The package contains {moveModules.length} Move modules that
							implement the platform functionality:
						</Text>
				...
				<Card>
					<Flex direction="column" gap="4">
						...
						<Text size="2" color="gray">
							Seal key servers provide encryption/decryption services for
							private content.
						</Text>
				...
				>
					<Flex direction="column" gap="3">
						...
						<Text size="2">
							This dApp uses Sui Move smart contracts for on-chain logic and
							Mysten Labs' Seal protocol for end-to-end encryption of private
							content. Publications and articles are managed on-chain, while
							encrypted content is stored off-chain and only decryptable by
							authorized subscribers.
						</Text>
						<Text size="2">
							Subscriptions are implemented as NFTs stored in user Kiosks,
							enabling trading and royalty distribution through Sui's transfer
							policy framework.
						</Text>
					</Flex>
				</Card>
