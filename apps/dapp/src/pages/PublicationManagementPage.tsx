		...
		<Container size="3" py="6">
			...
			<Callout.Root color="blue" mb="4">
				...
				<Callout.Text>
					...
					<br />
					Full management features coming in Phase 2. This will include: article
					management, pricing updates, analytics overview, and settings.
				</Callout.Text>
			</Callout.Root>
				...
				<Flex direction="column" gap="4">
					...
					<Flex gap="6">
						...
						<Box>
							...
							<Text size="6" weight="bold">
								{(
									BigInt(publication.basic_price) / BigInt(1_000_000_000)
								).toString()}{" "}
								SUI
							</Text>
						</Box>
						...
						<Box>
							...
							<Text size="6" weight="bold">
								{(
									BigInt(publication.premium_price) / BigInt(1_000_000_000)
								).toString()}{" "}
								SUI
							</Text>
						</Box>
