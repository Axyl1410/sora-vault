...
import {
	...
	usePublicationStats,
} from "../hooks/usePublicationQueries";
			...
			<Flex direction="column" gap="6">
						...
						<Grid columns={{ initial: "1", sm: "3" }} gap="4">
							<Flex direction="column" gap="1">
								...
								<Text size="2" weight="bold">
									{shortenAddress(publication.creator)}
								</Text>
							</Flex>
							<Flex direction="column" gap="1">
								<Text size="1" color="gray">
				...
				{isSubscribed && userSubscription && (
					<Callout.Root color="green">
						...
						<Callout.Text>
							You have an active {getTierName(userSubscription.tier)}{" "}
							subscription
						</Callout.Text>
					</Callout.Root>
				)}
				...
				<Flex direction="column" gap="3">
					...
					{nonArchivedArticles.length === 0 ? (
						<Callout.Root>
							...
							<Callout.Text>No articles published yet.</Callout.Text>
						</Callout.Root>
					) : (
												...
												{canAccess ? (
													...
													<Button
														...
														onClick={() => {
															...
															document
																.querySelector("[data-subscription-tiers]")
					...
					<Flex direction="column" gap="3">
						...
						<Grid columns={{ initial: "1", sm: "2" }} gap="4">
							<Flex direction="column" gap="2">
								...
								<Text size="2">
									Basic: {mistToSui(publication.basic_price)} SUI/month
								</Text>
								<Text size="2">
									Premium: {mistToSui(publication.premium_price)} SUI/month
								</Text>
							</Flex>
							<Flex direction="column" gap="2">
								<Text size="2" weight="bold">
								...
								{stats && (
									<>
										...
										<Text size="2">
											Revenue: {mistToSui(stats.total_revenue)} SUI
										</Text>
									</>
								)}
							</Flex>
