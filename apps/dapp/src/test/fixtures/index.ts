 ...
 */
export const mockKeyServers = ["0xkeyserver1", "0xkeyserver2"];
...
export const createMockPublication = (
...
export const createMockSubscription = (
	overrides: Partial<SubscriptionNFT> = {},
): SubscriptionNFT => ({
	...mockSubscription,
	...overrides,
});

export const createMockReadToken = (
	overrides: Partial<ReadToken> = {},
): ReadToken => ({
	...mockReadToken,
	...overrides,
});
