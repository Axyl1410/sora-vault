...
import type { ReaderPersona } from "../../types/persona";
			...
			<Flex direction="column" gap="5">
				...
				<Box>
					...
					<Text size="2" color="gray">
						Choose how you'd like to browse and read content. You can change
						this anytime.
					</Text>
				</Box>
				...
				>
					<Text size="2" color="gray">
						💡 Your preference is saved automatically and applies across all
