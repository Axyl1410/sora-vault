...
import {
	calculateDailyRate,
	usePurchaseReadToken,
} from "../../hooks/useReadTokenPurchase";
import type { Article, Publication } from "../../types";
import { logger } from "../../utils/logger";
import { getTierColor, getTierName, mistToSui } from "../../utils/sui";
...
export function ArticleAccessGate({
	...
	return (
		<Card
			style={{ background: "var(--amber-a2)", borderColor: "var(--amber-a6)" }}
		>
					...
					<Card>
						<Flex direction="column" gap="2">
							...
							<Text size="2" color="gray">
								Get unlimited access to all {getTierName(article.tier)} tier
								articles for 30 days
							</Text>
							<Flex gap="2">
								<Text size="2">
									{getTierName(article.tier)} Tier:{" "}
									{mistToSui(
										article.tier === 1
								...
								<Dialog.Content>
									...
									<Flex direction="column" gap="4">
										...
										<Callout.Root>
											...
											<Callout.Text>
												For better value, consider subscribing to get unlimited
